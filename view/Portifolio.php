  ...
  if (isset($_SESSION['perfil'])) {
    ...
    if (isset($perfil)) {
      ...
      foreach ($perfil as $p) {
        ...
        echo '<button class="navbar-toggler" type="button" onclick="removeSeccaoInput()" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
